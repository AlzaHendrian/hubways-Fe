        ...
        <>
            ...
            <Container className="margin-top-content" fluid>
                ...
                <Container className="mt-4">
                    ...
                    <div className="d-flex warp justify-content-start gap-3">
                        {getChannel?.video.map((value) => {
                            return (
                                <div key={value.id} className="d-flex flex-column mb-3 p-2 rounded" style={{ width: "320px", backgroundColor: "#0b0b0b" }}>
